  ...
  <a href="/index/index.php"></a>
    <div class="header">
        ...
        <nav id="navbar">
         <ul>
        <section id="li-section">
        <li><a>Къде?</a></li></section>
<section id="li-section">
        <li><a href="/ecology/ecology.php">Екология</a></li> 
        <li><a href="/hardware/hardware.php">Компоненти и части</a></li>
        <li><a href="#">Всекидневие </a></li>
            </section>
            <section id="li-section">
            <li><a href="#" ><?php echo  $loginLinkText ?></a></li> <li id="date"><a><?php echo  date("Y/m/d") ;?></a></li> <li><a href="/index/index.php?logout=true">Изход</a></li>
  ...
  <h1 class="typewrite-box">
      <a href="" class="typewrite" data-period="2000" data-type='[ "Това място ще ви помогне с вашия избор", "Моля, първо изберете категория, която да ви помогне" ]'>
      <span class="wrap"></span>
...
<section id="ecology">
  ...
  <div class="box" data-animation="slideInUp" data-animation-delay=".2s">
   ...
   <div class="box" data-animation="slideInUp" data-animation-delay=".2s">
    ...
    <h1 class="description"> Тази страница ще ви помогне с избора на доброволческа активност</h1>
...
<!--category-->
   <section id="category" class="category2">
    ...
    <div class="box" data-animation="slideInUp" data-animation-delay=".2s">
     ...
     <div class="box" data-animation="slideInUp" data-animation-delay=".2s">
      ...
      <h1 class="description"> Тази страница ще ви помогне с избора на компоненти за вашият компютър</h1>
   ...
   <!--Slide-->
     <div class="box" data-animation="slideInUp" data-animation-delay=".2s">
      ...
      <div id="TheHoleButton">  
        <div class="button-wrapper">
        <button  class="button" type="submit" value="Sign Up">Компоненти</button>
     <div class="button-bg" id="button-bg2"></div>
        </a>
     ...
     <section id="category" class="category3">
      ...
      <div class="box" data-animation="slideInUp" data-animation-delay=".2s">
       ...
       <div class="box" data-animation="slideInUp" data-animation-delay=".2s">
        ...
        <h1 class="description"> Тази страница ще ви помогне с </h1>
  ...
  <section id="reason">
   ...
   <section class="why">
    <div class="evenboxinner">
      ...
      <p > Нашият екип реши да създаде това, защото имахме проблем с намирането на екологична дейност за ученически проект. Затова сме сигурни, че не сме единствените с този проблем. 
        Затова решихме да създадем този уебсайт.</p>
    </div>
  </section>
  <section class="why" >
  <div class="evenboxinner">
    ...
    <p >  Една от другите причини за създаването на този уебсайт е, че искахме да знаем цената на определен хардуерен продукт (Nvidia GeForce RTX 4060), но не знаехме къде да търсим.
    </p>
  </div>
